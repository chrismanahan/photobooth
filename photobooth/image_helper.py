...
class ImageHelper:
	...
	def create_text_image(self, img, text, font_size, position, background_color = None):
		drawing = ImageDraw.Draw(img)
		w, h = drawing.textsize(text, font=self.get_font(font_size))
		if background_color is not None:
			pad = 50
			self.create_rectangle(img, w + pad, h + pad, background_color, position)
	...
	def create_rectangle(self, img, w, h, color, position, outline_color = "black"):
		drawing = ImageDraw.Draw(img)
		bounding_box = self.createBoundingBox(position, w, h)
